Feature: Patient Service
  ...
  Scenario: Add Patient
    When A Patient Post Request is sent with values 12345678, "Patrick", "Ortiz", 19, "Av. Abcd"
    Then A Response with Status 200 is received for Patient
    And A Patient Resource with values 12345678, "Patrick", "Ortiz", 19, "Av. Abcd" is included in Response Body

  @patient-duplicated
  Scenario: Add Patient with existing Dni
    Given A Patient Resource with values 12345678, "Patrick", "Ortiz", 19, "Av. Abcd" is already stored
    When A Patient Post Request is sent with values 12345678, "Patrick", "Ortiz", 19, "Av. Abcd"
