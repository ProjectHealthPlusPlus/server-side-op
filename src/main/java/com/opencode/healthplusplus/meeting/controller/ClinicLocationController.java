...
public class ClinicLocationController {
    ...
    @Operation(summary = "Get a clinicLocation by id", description = "Get A ClinicLocation By Id")
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "ClinicLocation found",
                    content = {
                            @Content(
                                    mediaType = "application/json",
                                    schema = @Schema(
    ...
    @Operation(summary = "Create a clinicLocation", description = "Create A ClinicLocation.")
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "ClinicLocation created",
                    content = {
                            @Content(
                                    mediaType = "application/json",
                                    schema = @Schema(
    ...
    @Operation(summary = "Edit a clinicLocation", description = "Edit A ClinicLocation By Given An Id.")
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "ClinicLocation edited",
                    content = {
                            @Content(
                                    mediaType = "application/json",
                                    schema = @Schema(
    ...
    @Operation(summary = "Delete a clinicLocation", description = "Delete A ClinicLocation By Given An Id.")
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "ClinicLocation deleted"
            )
    })
